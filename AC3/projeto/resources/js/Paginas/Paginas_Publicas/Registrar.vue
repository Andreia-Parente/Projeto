    ...
    <div class="container-xxl">
        ...
        <div class="authentication-inner">
            <div class="card">
                ...
                <p class="mb-4">Por favor crie uma conta e comece a aventura</p>
                <!--cria o formulario para registrar o utilizador-->
                <form id="formAuthentication" class="mb-3" @submit.prevent="registrarData">
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-between">
                            <label for="password" class="form-label">Palavra-Passe:</label>
                                <input type="password" id="password" class="form-control" name="password"  v-model="form.password"
                                    placeholder="Introduza a palavra-passe" aria-describedby="password"/>
                        </div>
                    </div>
                    <!--cria o botao-->
                    <div class="mb-3">
              ...
              <!--se ja tem conta envia o utilizador na pagina entrar-->
              <p class="text-center">
...
export default{
    ...
    //cria os metodos 
    methods: {
        //envia os valores do formulario para o route registrar
        registrarData(){
            this.form.post(route('registrar'));
        }
    }  
}
</script>
